...
Three source files were modified: \texttt{grammar.cc}, \texttt{expr.cc}, and
\texttt{relmodel.hh}.
...
\begin{itemize}
    \item aliases in the table naming are disabled, using the table name directly.
...
\begin{enumerate}
    ...
    \item \textbf{Enforcing non-nested aggregate functions} by modifying the
...
\end{lstlisting}
    ...
    \item removing complex or system-defined functions from the generative process.
\end{enumerate}
...
A representative query produced after customization is:
